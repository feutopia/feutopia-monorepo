...
export class Scrollbar {
  ...
  #scrollAnimationId: number | null = null; // Animation frame ID for smooth scrolling
  #scrollOffset = 0; // Current scroll position
  #maxScrollDistance = 0; // Maximum scrollable distance
  #scrollInterval: number | null = null; // Timer ID for interval-based scrolling
  #cleanupEvents: Array<() => void> = []; // Array to store event removal callbacks
